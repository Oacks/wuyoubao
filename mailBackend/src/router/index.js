            ...
            children: [
                {
                    path: '/contract',
                    name: 'contract',
                    component: () => import(/* webpackChunkName: "contract" */ '../components/page/main/ContractManage.vue'),
                    meta: { title: '合同管理' }
                },
                {
                    path: '/card',
                    name: 'card',
                    component: () => import(/* webpackChunkName: "card" */ '../components/page/main/CardManage.vue'),
                    meta: { title: '无忧宝卡管理' }
                },
                {
                    path: '/postprodt',

...
export const getSms = query => {
    return get('user/getHtSMS', query)
}

// 手机登录
export const loginByMobile = query => {
    return post('user/loginByMobile', query)
}
...
/********************** 无忧保后台********************/
// 4s店合同
export const shopContractList = query => {
    return get('wyht/shopContractList', query)
}

// 
export const sold = query => {
    return get('wyht/isSale', query)
}
...
// 报障列表
export const shopGuarantee = query => {
    return get('wyht/shopGuarantee', query)
}
...
// 查看报障详情
export const shopGuaranteeFishList = query => {
    return get('wyht/shopGuaranteeFishList', query)
} 

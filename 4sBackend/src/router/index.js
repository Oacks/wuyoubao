            ...
            children: [
                {
                    path: '/contract',
                    name: 'contract',
                    component: () => import(/* webpackChunkName: "contract" */ '../components/page/main/Contract.vue'),
                    meta: { title: '合同管理' }
                },
                {
                    path: '/price',
                    name: 'price',
                    component: () => import(/* webpackChunkName: "shop" */ '../components/page/main/PriceManage.vue'),
                    meta: { title: '店铺管理' }
                },
                {
                    path: '/error',
                ...
                },
                {
                    path: '/payment',
                    name: 'payment',
                    component: () => import(/* webpackChunkName: "shop" */ '../components/page/main/PaymentManage.vue'),
                    meta: { title: '收款管理' }
                },
                {
                    path: '/sendcard',

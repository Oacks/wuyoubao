...
<!-- 
            ...
            <el-table-column prop="memberName" label="付款状态">
                <template slot-scope="scope">
                    {{scope.row.isSale == 1 ? '已付款' : '未付款'}}
                </template>
            </el-table-column>
            <el-table-column label="操作">
                <template slot-scope="scope">
                    <div >
                        ...
                        <el-button v-if="scope.row.isSale != 1" size="mini" type="warning" @click="sold(scope.row)">已付款</el-button>
